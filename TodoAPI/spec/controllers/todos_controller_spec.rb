  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved todo as @todo" do
        ...
        post :create, {:todo => { "text" => "invalid value" }}, valid_session
        assigns(:todo).should be_a_new(Todo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested todo" do
        ...
        Todo.any_instance.should_receive(:update).with({ "text" => "MyText" })
        put :update, {:id => todo.to_param, :todo => { "text" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the todo as @todo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Todo.any_instance.stub(:save).and_return(false)
        put :update, {:id => todo.to_param, :todo => { "text" => "invalid value" }}, valid_session
        assigns(:todo).should eq(todo)
      end
